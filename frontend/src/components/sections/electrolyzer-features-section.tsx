      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 h-full">
            <h2 className="text-3xl sm:text-8xl md:text-10xl font-bold leading-tight">
          ...
          <div className="space-y-8">
            {features.map((feature) => (
              <Card key={feature.title} className="bg-card xl:h-80 p-6 border  shadow-lg overflow-hidden">
                <CardContent className="flex justify-center items-center">
                  <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-6 sm:space-y-0 sm:space-x-6 w-full h-full">
                    ...
                    <div className="flex-1">
                      <h3 className="text-2xl xl:text-4xl font-semibold text-card-foreground mb-4">{feature.title}</h3>
                      <p className="text-md xl:text-xl text-muted-foreground">{feature.description}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
            ))}
             <AnimatedButton href="/product" variant="primary" className="mt-6 w-full ">
                Explore more
            </AnimatedButton>
          </div>
        </div>
